	...
	<div class="trade-container">
		...
		<div class="trade">
			...
			<div class="receiveInfo">
				寄送至:
				<span>{{ userDeaultAddress.fullAddress }}</span>
				收货人：<span>{{ userDeaultAddress.consignee }}</span>
				<span>{{ userDeaultAddress.phoneNum }}</span>
			</div>
		</div>
...
export default {
	...
	methods: {
		...
		//提交订单(此处尝试不使用vuex管理请求)
		async submitOrder() {
			let { tradeNo } = this.orderInfo;
			let data = {
				consignee: this.userDeaultAddress.consignee,
				consigneeTel: this.userDeaultAddress.phoneNum,
				deliveryAddress: this.userDeaultAddress.fullAddress,
				paymentWay: 'ONLINE',
